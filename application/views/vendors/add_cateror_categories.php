            ...
            <div class="row">
                <div class="col-md-12">
                    <?php $form_attributes = array('class' => 'form-horizontal', 'id' => 'vendoraddform');  
                        echo form_open_multipart("catering_categories/add_cateror_categories", $form_attributes);
                    ?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Add Categories</strong> </h3>
                        ...
                        <div class="panel-body">   
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Categories Type Name</label>
