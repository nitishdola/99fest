        ...
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="#">Add a event ticket</a></li>
        </ul>
        <!-- END BREADCRUMB -->
            ...
            <div class="row">
                <div class="col-md-12">
					<?php $form_attributes = array('class' => 'form-horizontal', 'id' => 'ticketaddform');	
						echo form_open("events/create_tickets", $form_attributes);
					?>
                        ...
                        <div class="panel-body">  
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">                                                                                            
                                    ...
                                    endforeach;
                                    ?>
                                    <?php echo form_dropdown('event_id', $list_events, 0,'class="form-control" id="event_id"'); ?>
                                    <span class="help-block"></span>                                        
                                </div>
                            </div>                                                                      
                            
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Ticket Name</label>
                                <div class="col-md-6 col-xs-12">                                            
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                        <?php 
                                            $ticket_name_data = array(
                                              'name'        => 'name',
                                              'id'          => 'name',
                                        ...
                                        ?>
                                        <?php echo form_input($ticket_name_data);?>
                                    </div>                                            
                                    <span class="help-block">Type ticket name eg West Platinum Stand</span>                                        
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Ticket Rate</label>
                                <div class="col-md-6 col-xs-12">                                            
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                        <?php 
                                            $ticket_rate_data = array(
                                              'name'        => 'rate',
                                              'id'          => 'rate',
                                        ...
                                        ?>
                                        <?php echo form_input($ticket_rate_data);?>
                                    </div>                                            
                                    <span class="help-block"></span>                                        
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Ticket Issued</label>
                                <div class="col-md-6 col-xs-12">                                            
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                        <?php 
                                            $ticket_issued_data = array(
                                              'name'        => 'tickets_issued',
                                              'id'          => 'tickets_issued',
                                              'placeholder' => 'Enter total ticket issued',
                                              'class'       => 'form-control',
											  'type'		=> 'number',
                                            );

                                        ?>
                                        <?php echo form_input($ticket_issued_data);?>
                                    </div>                                            
                                    <span class="help-block"></span>                                        
                                </div>
                            </div>
