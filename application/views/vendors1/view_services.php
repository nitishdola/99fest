                                        ...
                                        <table class="table table-bordered table-striped table-actions">
                                          ...
                                          <?php foreach($services as $k => $v){ ?>                                           
                                                <tr id="trow_1">
                                                    ...
                                                    <td> <?php echo $k+1; ?></td>
                                                    <td><strong><?php echo ucfirst(strtolower($v->type_name)); ?></strong></td>
                                                    <td><strong><?php echo ($v->rate); ?></strong></td>
                                                    <td><strong><?php echo($v->rate); ?></strong></td>
                                                   
                                                    
                                                    <td><button class="btn btn-default btn-rounded btn-sm"> <a  title="View Vendor" target="_blank" href="<?php echo base_url();?>vendors/information/<?php echo $v->user_id;?>"><span class="fa fa-pencil"></span></i></a></button></td>
                                                    <td><button class="btn btn-default btn-rounded btn-sm"><a  title="Delete Vendor" target="_blank" href="<?php echo base_url();?>vendors/trash/<?php echo $v->user_id;?>"><span class="fa fa-times"></span></button></a></button>
