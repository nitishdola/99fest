...
<div class="page-title">                    
    <h2><span class="fa fa-bars"></span> Event Managers</h2>
</div>
<!-- END PAGE TITLE --> 
<!-- START BREADCRUMB -->
<ul class="breadcrumb">
    ...
    <li class="active"><a href="#">View All Event Managers</a></li>
</ul>
<!-- END BREADCRUMB -->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $v->statename; ?></td>
                                <td>

                                    <?php if($v->active == 1){ ?>
                                    <button class="btn btn-warning btn-xs change_status" onclick="disableEventManager(<?= $v->id; ?>)"><span class="glyphicon glyphicon-remove"></span> Disable</button>
                                    <?php }else{ ?>
                                    <button class="btn btn-success btn-xs change_status" onclick="enableEventManager(<?= $v->id; ?>)"><span class="glyphicon glyphicon-ok"></span> Ebanle</button>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php } ?>
                    ...
                    <script>
                        ...
                        function enableEventManager(id) {
                            change_manager_status(id,1);
                        }

                        function disableEventManager(id) {
                            change_manager_status(id,0);
                        }

                        function change_manager_status(id, status) {
                            $('#overlay').show();

                            var url_to_call = '';
                            url_to_call += '<?= base_url(); ?>event_managers/change_manager_status';
                            ...
                            $.ajax({
                                ...
                                success : function(resp) {
                                    $('#overlay').hide();
                                    window.location.href = "<?= base_url(); ?>event-managers/view-all";
                                }
                            });
                        }
                    </script>
