        ...
        <div class="page-content-wrap">
        	<div class="col-md-12">
        		...
        		<div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Vendor Images</strong> </h3>
                        <ul class="panel-controls">
                            <li><a href="#" class="panel-remove"><span class="fa fa-times"></span></a></li>
                        </ul>
                    </div>
                    <div class="panel-body">
						<?php if(!empty($vendor_images)) { ?>
							<?php foreach($vendor_images as $vimg) { ?>
								<div class="col-md-4">
									<p><b>Category : <?php echo $vimg->name; ?></b></p>
									<img src="<?php echo uploads_url().'vendors/images/'. $vimg->path;?>" width="300" height="160" />
								</div>
							<?php } ?>
						<?php }else{ ?>
