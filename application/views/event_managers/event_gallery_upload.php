<style>
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><a href="#">Add event gallery</a></li>
    </ul>
    <!-- END BREADCRUMB -->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
				<?php $form_attributes = array('class' => 'form-horizontal', 'id' => 'eventgalleryform');	
					echo form_open_multipart("event_managers/event_image_gallery_upload", $form_attributes);
				?>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Upload Image</strong> </h3>
                    ...
                    <div class="panel-body">                                                                        
						...
						<label class="col-md-4 control-label" for="filebutton">Image <?php echo $i; ?></label>
						<div class="form-group">
						 <div class="col-md-4">
						    <?php 
				                $event_gallery_image_data = array(
				                  'name'        => 'image'.$i,
				                  'id'          => 'image'.$i,
				            ...
				            ?>
				            <?php echo form_input($event_gallery_image_data);?>
						  </div>
						</div>
						 <?php } ?>
                    ...
                    <div class="form-group">
					  ...
					  <div class="col-md-4">                               
                        ...
                        <span class="help-block">IMAGE DIMESNION <strong>220x130</strong></span>   
			        </div>
			        <?php echo form_close();?>
                </div>
