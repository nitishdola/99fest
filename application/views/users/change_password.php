    ...
    <div class="page-content-wrap" style="padding:0 30px;">                    
         ...
         <div class="row">
            <div class="col-md-12">
                ...
                <?php $form_attributes = array('class' => 'form-horizontal', 'id' => 'changePasswordForm');   
                    echo form_open_multipart("users/change_password", $form_attributes);
                ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">                                            
                                <div class="input-group">
                                    ...
                                    ?>
                                    <?php echo form_password($old_data);?>
                                </div>                                            
