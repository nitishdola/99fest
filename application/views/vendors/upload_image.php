            ...
            <div class="row">
                ...
                <div class="col-md-12">
					<?php $form_attributes = array('class' => 'form-horizontal', 'id' => 'vendoraddform');	
						echo form_open_multipart('vendors/upload_image', $form_attributes);
					?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Add Vendor Infromation</strong> </h3>
                                ...
                                <div class="col-md-6 col-xs-12">                                            
                                    <div class="input-group">
										...
										<?php foreach($categories as $k => $v) {
											$vendor_categories[$v->vendor_category_id] = $v->name;
										}
										?>
										<?php echo form_dropdown('vendor_category_id', $vendor_categories, 0,'class="form-control" id="vendors_category_id"'); ?>
                                    </div>                                            
                                    <span class="help-block">Type category</span>                                        </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Image Featured</label>
                                <div class="col-md-6 col-xs-12">                                                                                            
