        ...
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="#">Add a event category</a></li>
        </ul>
        <!-- END BREADCRUMB -->
            ...
            <div class="row">
                <div class="col-md-12">
					<?php $form_attributes = array('class' => 'form-horizontal', 'id' => 'vendoraddform');	
						echo form_open("event_categories/add", $form_attributes);
					?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Add Event Category</strong> </h3>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">                                            
                                    <div class="input-group">
                                        ...
                                        ?>
                                        <?php echo form_input($event_cat_data);?>
                                    </div>                                            
                                    <span class="help-block">Type event category name eg Trade Shows</span>                                        
                                </div>
                            </div>
                        </div>
